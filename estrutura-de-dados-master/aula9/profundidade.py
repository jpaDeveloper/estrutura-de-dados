...
class Noh:
    ...
    def adicionar(self, novoFilho):
        ...
        elif self.filho_esquerdo.irmao_direito:
            novoFilho.pai = self
            self.filho_esquerdo.irmao_direito.irmao_direito = novoFilho
        else: self.filho_esquerdo.irmao_direito = novoFilho
...
class Arvore:
    ...
    def __iter__(self):
        if self.raiz:
            ...
            while pilha:
                no = pilha.pop()
                if no.irmao_direito: pilha.append(no.irmao_direito)
                if no.filho_esquerdo: pilha.append(no.filho_esquerdo)
                yield no.valor
        else: return self.raiz
