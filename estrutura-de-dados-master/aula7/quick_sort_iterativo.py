...
def _quick_recursivo(seq, inicio, final):
    ...
    # pivot
    while i_direita > i_esquerda:
        if seq[i_esquerda] <= pivot: i_esquerda = i_esquerda + 1
        elif seq[i_direita] >= pivot: i_direita = i_direita - 1
        else: seq[i_esquerda], seq[i_direita] = seq[i_direita], seq[i_esquerda]
